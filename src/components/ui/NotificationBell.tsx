...
export function NotificationBell({ notifications, setNotifications }: NotificationBellProps) {
  ...
  const [fullMessage, setFullMessage] = useState<{text: string; title?: string} | null>(null);
  ...
  return (
    <>
                  ...
                  >
                          ...
                          <>
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                e.preventDefault();
                                console.log("Opening full message modal:", n.message);
                                setFullMessage({
                                  text: n.message,
                                  title: n.type === 'transfer_approved'
                                    ? 'Transfer Approval'
                    ...
                    {n.meta && n.meta.rejectionReason && n.type === 'transfer_rejected' && (
                      <div className="mt-1 text-xs text-red-700 bg-red-50 p-2 rounded">
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              e.preventDefault();
                              console.log("Opening rejection reason modal:", n.meta.rejectionReason);
                              setFullMessage({
                                text: n.meta.rejectionReason,
                        ...
                        <div className="mt-1">
                          {n.meta.rejectionReason.length > 50
                            ? n.meta.rejectionReason.substring(0, 50) + '...'
                            : n.meta.rejectionReason}
                        </div>
                      </div>
                    )}
                  </li>
      ...
      {fullMessage && isBrowser && createPortal(
        <div
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                {fullMessage.title || 'Notification'}
              </h3>
              <button
