...
//           ? new Date(scheduleData.endDate).toISOString().split("T")[0]
//           : "",
...
//         setUsers(
//           usersData.filter((user: User) => user.id !== session?.user?.id)
//         );
//       }
...
//           ? parseInt(formData.customInterval)
//           : undefined,
...
//         alert(
//           `Failed to update schedule: ${errorData.error || "Unknown error"}`
//         );
//       }
//     } catch (error) {
...
//             The maintenance schedule you are trying to edit does not exist.
//           </p>
//           <button
...
//                     Asset cannot be changed after schedule creation
//                   </p>
//                 </div>
//               </div>
//             </div>
